...
class JournalistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journalist" do
    assert_difference('Journalist.count') do
      post journalists_url, params: { journalist: { first: @journalist.first, last: @journalist.last } }
    end
  ...
  test "should update journalist" do
    patch journalist_url(@journalist), params: { journalist: { first: @journalist.first, last: @journalist.last } }
